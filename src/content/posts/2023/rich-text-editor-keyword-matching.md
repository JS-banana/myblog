...
date: '2023-09-23'
description: 介绍如何在富文本编辑器中实现$关键字智能匹配功能，通过光标选区插入变量并高亮显示，提升邮件模板编辑效率。
tags:
  - 实战
  - vue
slug: rich-text-editor-keyword-matching
source: blog
sourcePath: blog/2023/基于富文本编辑器的$关键字智能匹配功能.md
sourceId: post-blog-2023-rich-text-editor-keyword-matching
---
