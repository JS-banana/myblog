...
date: '2023-03-30'
description: 本文介绍虚拟列表技术，教你3分钟快速实现高性能列表组件，优雅处理大数据渲染，解决万级数据渲染性能问题。
tags:
  - vue
slug: virtual-list-beginner-guide-high-performance-rendering
source: blog
sourcePath: blog/2023/虚拟列表入门篇.md
sourceId: post-blog-2023-virtual-list-beginner-guide-high-performance-rendering
---
