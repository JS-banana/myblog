...
title: 执行上下文
date: '2024-03-20'
description: 深入解析JavaScript执行上下文，包括全局、函数和Eval三种类型，帮助理解闭包和作用域链的基础概念。
tags:
  - JavaScript
slug: javascript-execution-context-explained
source: blog
sourcePath: blog/2024/执行上下文.md
sourceId: post-blog-2024-javascript-execution-context-explained
---
