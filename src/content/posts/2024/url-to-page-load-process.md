...
date: '2024-03-29'
description: 详解从输入URL到页面加载完成的完整流程，涵盖DNS解析、TCP连接、HTTP请求、浏览器渲染等核心技术环节，帮助开发者深入理解前端性能优化原理。
tags:
  - 浏览器
slug: url-to-page-load-process
source: blog
sourcePath: blog/2024/从输入 URL 到页面加载完成发生了什么？.md
sourceId: post-blog-2024-url-to-page-load-process
---
