...
date: '2021-11-29'
description: >-
  本文总结使用Vite、Vue3和TypeScript开发项目的实践经验，涵盖Composition API、Script
  Setup等新特性，提升开发效率和代码质量。
tags:
  - vue
slug: vite-vue3-typescript-development-guide
source: blog
sourcePath: blog/2021/vue3使用总结.md
sourceId: post-blog-2021-vite-vue3-typescript-development-guide
---
