...
date: '2022-09-06'
description: 对比分析JSON、YAML、TOML三种配置文件格式的特点、适用场景及技术演进背景，帮助开发者选择最适合的配置方案。
tags:
  - null
slug: json-yaml-toml-config-file-analysis
source: blog
sourcePath: blog/2022/不同类型的配置文件分析.md
sourceId: post-blog-2022-json-yaml-toml-config-file-analysis
---
