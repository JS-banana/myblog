...
title: vue编译为js的研究
date: '2022-12-07'
description: 探讨Vue文件如何编译为JS和HTML，实现报告导出功能，深入理解编译原理在Vue项目中的应用。
tags:
  - vue
slug: vue-compilation-to-js-research
source: blog
sourcePath: blog/2022/vue编译为js的研究.md
sourceId: post-blog-2022-vue-compilation-to-js-research
---
